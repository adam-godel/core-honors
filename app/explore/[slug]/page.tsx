    ...
    >
      ...
      >
        ...
        >
          ...
          <path d="M4 12h10v1.5H4V12zm0 3h10v1.5H4V15zm0-6h6v1.5H4V9z" fill="white" fillOpacity="0.85" />
        </svg>
        {menuItems.map((item) => (
          <span
            key={item}
  ...
  return (
    ...
    >
      ...
      <svg width="8" height="5" viewBox="0 0 8 5" fill="none">
        <path d="M1 1l3 3 3-3" stroke="#5f6368" strokeWidth="1.4" strokeLinecap="round" />
      </svg>
    </div>
  );
}
...
function ToolbarColorBtn() {
  return (
    ...
    >
      <span>A</span>
      <span style={{ width: "14px", height: "3px", background: "#fbbc04", borderRadius: "1px" }} />
    </span>
  );
}
  ...
  return (
    ...
    >
      <svg width="14" height="12" viewBox="0 0 14 12" fill="none">
        <path d="M1 1h12M1 4.5h8M1 8h12M1 11.5h8" stroke="#5f6368" strokeWidth="1.3" strokeLinecap="round" />
      </svg>
    </span>
  );
}
...
function ToolbarListBtn({ ordered }: { ordered?: boolean }) {
  return (
    ...
    >
      {ordered ? (
        <svg width="14" height="12" viewBox="0 0 14 12" fill="none">
          <path d="M5 2h8M5 6h8M5 10h8" stroke="#5f6368" strokeWidth="1.3" strokeLinecap="round" />
          <text x="0" y="3" fontSize="4.5" fill="#5f6368">1.</text>
          <text x="0" y="7" fontSize="4.5" fill="#5f6368">2.</text>
          <text x="0" y="11" fontSize="4.5" fill="#5f6368">3.</text>
        </svg>
      ) : (
        <svg width="14" height="12" viewBox="0 0 14 12" fill="none">
          <path d="M5 2h8M5 6h8M5 10h8" stroke="#5f6368" strokeWidth="1.3" strokeLinecap="round" />
...
function DocRuler() {
  // ~72px per inch at 96 dpi, margin indicators at 1 inch from each side
  const ticks = Array.from({ length: 19 }, (_, i) => i); // 0–18 half-inches
  return (
    <div
      style={{
        position: "relative",
    ...
    >
      ...
      />
      {/* Tick marks at half-inch intervals */}
      {ticks.map((i) => {
        const isInch = i % 2 === 0;
        const x = 72 + i * 36; // 36px = 0.5 inch
        return (
          <div
            key={i}
            style={{
        ...
        <div className="flex justify-center px-4 py-10 pb-24">
          <div
            ...
            style={{
              ...
              borderRadius: "2px",
              boxShadow:
                "0 1px 3px rgba(0,0,0,0.25), 0 8px 40px rgba(0,0,0,0.35)",
            }}
          >
            <DocToolbar />
            <article
